-- ============================================================================
-- 009_update_trigger_empresa.sql
-- Sistema de Auditoría y Actividad - Actualizar trigger para empresa_id
-- Proyecto: Open Energies CRM
-- Fecha: 2026-01-21
-- ============================================================================

-- Actualizar función genérica para registrar eventos de auditoría
-- Ahora también extrae empresa_id cuando sea relevante
...
COMMENT ON FUNCTION fn_registrar_actividad() IS 'Función trigger genérica para registrar eventos de auditoría en actividad_log. Usa TG_ARGV para recibir configuración. Ahora también captura empresa_id.';
