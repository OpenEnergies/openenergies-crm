...
// Modal de exportación CSV con filtros: fecha inicio/fin, comercializadora, tipo factura, agrupación
            ...
            >
                ...
                <div className="flex items-center justify-between p-6 border-b border-fenix-500/20 bg-bg-primary/50">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h3 className="text-xl font-bold text-fenix-600 dark:text-fenix-400">Exportar CSV</h3>
                    ...
                    <div className="flex-1 flex flex-col items-center justify-center p-12 gap-6 bg-bg-primary/30">
                        ...
                        <div className="text-center">
                            <p className="text-base font-semibold text-primary">
                                {exportPhase === 'done' ? '¡Archivo descargado!' : 'Generando archivo CSV...'}
                            </p>
                            {exportPhase === 'loading' && (
