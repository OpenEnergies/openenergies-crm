...
async function fetchTopPuntosEuros(): Promise<TopPuntoEuro[]> {
        ...
        <div className="glass-card p-5">
            ...
            {data && data.length === 0 && (
                <div className="text-center py-8 text-secondary opacity-60 font-medium italic">
                    No hay puntos con facturación registrada
                </div>
            )}
              ...
              `}>
                            ...
                            <div className="text-right flex-shrink-0">
                                <div className="flex items-center gap-1 text-fenix-600 dark:text-fourth font-bold">
                                    ...
                                    <span>{punto.total_euros.toLocaleString('es-ES', { maximumFractionDigits: 2 })} €</span>
                                </div>
                            </div>
                        </div>
                    ))}
