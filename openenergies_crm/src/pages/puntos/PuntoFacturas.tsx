// src/pages/puntos/PuntoFacturas.tsx
// Facturas table scoped to a single punto de suministro
...
// ============ FETCH FUNCTION ============
async function fetchFacturasByPunto(puntoId: string): Promise<FacturaCliente[]> {
...
// ============ MAIN COMPONENT ============
export default function PuntoFacturas({ puntoId }: { puntoId: string }) {
    ...
    const { data: facturas = [], isLoading, isError } = useQuery({
        ...
        queryFn: () => fetchFacturasByPunto(puntoId),
        enabled: !!puntoId,
    });
    ...
    if (isError) {
        return (
            <div className="glass-card p-6 text-red-400" role="alert">
                Error al cargar las facturas del punto.
            </div>
        );
    }
        ...
        <div className="glass-card overflow-hidden">
            ...
            <div className="p-6 border-b border-bg-intermediate">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-xl font-bold text-fenix-600 dark:text-fenix-500">Facturas del Punto</h2>
                    ...
                    <div className="flex items-center gap-3 w-full md:w-auto">
                        <div className="flex items-center gap-2 flex-1 md:flex-initial">
                            ...
                            <input
                                type="text"
                                placeholder="Nº factura, comercializadora..."
                                value={searchTerm}
            ...
            {displayedData.length === 0 ? (
                <EmptyState
                    ...
                    title="Sin facturas"
                    description={searchTerm ? 'No se encontraron facturas con ese criterio de búsqueda.' : 'Este punto no tiene facturas registradas.'}
                />
            ) : (
