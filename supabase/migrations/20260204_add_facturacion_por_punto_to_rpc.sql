-- =====================================================
-- MIGRACIÓN: Añadir facturación por punto a get_auditoria_energetica_data
-- =====================================================
-- Objetivo: Agregar campo "facturacion_por_punto" con consumo/coste por CUPS
-- para calcular correctamente los extremos Top3/Bottom3
    ...
    WITH facturacion_agregada AS (
        SELECT 
            ...
            CASE 
                ...
                THEN ROUND((SUM(fc.total) / SUM(fc.consumo_kwh))::NUMERIC, 4)
                ELSE 0 
            END AS precio_medio
        FROM facturacion_clientes fc
...
Retorna JSONB con:
  ...
  - facturacion_por_punto: Facturación agregada por punto_id en el período (para extremos)';
